...
so that migrations can be run against our asyncpg-backed PostgreSQL database.
"""
...
# Override sqlalchemy.url with the runtime DATABASE_URL from pydantic-settings
